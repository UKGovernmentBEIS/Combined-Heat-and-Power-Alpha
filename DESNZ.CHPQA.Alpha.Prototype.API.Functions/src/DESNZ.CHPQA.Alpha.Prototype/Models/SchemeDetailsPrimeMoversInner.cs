...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SchemeDetailsPrimeMoversInner : IEquatable<SchemeDetailsPrimeMoversInner>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SchemeDetailsPrimeMoversInner {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SchemeDetailsPrimeMoversInner)obj);
        }

        /// <summary>
        /// Returns true if SchemeDetailsPrimeMoversInner instances are equal
        /// </summary>
        /// <param name="other">Instance of SchemeDetailsPrimeMoversInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SchemeDetailsPrimeMoversInner other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Fuel != null)
                    hashCode = hashCode * 59 + Fuel.GetHashCode();
        ...
        public static bool operator ==(SchemeDetailsPrimeMoversInner left, SchemeDetailsPrimeMoversInner right)
        {
