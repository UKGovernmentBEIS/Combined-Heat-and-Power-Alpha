...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Meter : IEquatable<Meter>
    {
        /// <summary>
        /// Gets or Sets Tag
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Meter)obj);
        }

        /// <summary>
        /// Returns true if Meter instances are equal
        /// </summary>
        /// <param name="other">Instance of Meter to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Reading != null)
                    hashCode = hashCode * 59 + Reading.GetHashCode();
                return hashCode;
            }
        }
